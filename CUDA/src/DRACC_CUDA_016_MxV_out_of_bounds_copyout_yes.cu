/*
Matrix Vector multiplication with copying more data out from one vector than allocated.
*/
#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(){
    ...
    //Copying back twice the result d_c from the device to the host array c
    cudaErrorCheck( cudaMemcpy(c,d_c,2*C*sizeof(int),cudaMemcpyDeviceToHost)); 
