/*
Matrix Vector multiplication with fliped source and destination pointer on copy in. See line 88.
*/
#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
...
int initcuda(){
    ...
    //Flipped source and destination pointer
    cudaErrorCheck( cudaMemcpy(b,d_b,C*C*sizeof(int),cudaMemcpyHostToDevice));
