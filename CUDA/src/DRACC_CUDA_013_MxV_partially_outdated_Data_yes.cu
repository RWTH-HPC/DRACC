/*
Matrix Vector multiplication with partially missing cuda copy of the result vector.
*/
#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(){
    ...
    cudaErrorCheck( cudaMemcpy(c,d_c,C*sizeof(int)/2,cudaMemcpyDeviceToHost)); 
