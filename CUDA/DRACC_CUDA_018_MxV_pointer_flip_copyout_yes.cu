/*
Matrix Vector multiplication with fliped source and destination pointer on copy in, in line 109.
*/
#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
...
int main(){
    ...
    cudaErrorCheck( cudaMemcpy(d_c,c,C*sizeof(int),cudaMemcpyDeviceToHost)); 
